...
Use this to keep Unicore-specific UART setup inside the V12 board directory.
)DESCR_STR");

	PRINT_MODULE_USAGE_NAME_SIMPLE("v12_gpsinit", "command");
...
extern "C" __EXPORT int v12_gpsinit_main(int argc, char *argv[])
{
	Config config {};
